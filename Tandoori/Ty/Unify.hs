...
substTy s (HsForAllTy e bndr lctxt lty) = HsForAllTy e bndr' lctxt' lty'
    where bndr' = bndr
          lctxt' = lctxt
          lty' = lsubstTy s lty
...
mgu' leftOnly ((ty@(HsForAllTy _ _ lctxt (L _ t)), t')                           :eqs)                  = case mgu' leftOnly $ (t, t'):eqs of
                                                                                                            Left errs -> Left errs
                                                                                                            Right s -> error $ unwords [showTy ty, "|", showSubst s]
mgu' leftOnly ((t,                            ty@(HsForAllTy _ _ lctxt (L _ t'))):eqs)                  = case mgu' leftOnly $ (t, t'):eqs of
                                                                                                            Left errs -> Left errs
                                                                                                            Right s -> error $ unwords [showTy ty, "|", showSubst s]
